...
token = 'MTE2MzA5Mjc1MTA5Nzc5NDYxMQ.GHlKSZ.J8cyv89MzJgJ9hbiEpQlaGBXz6Nx93bqcYI8lc'
prefix = '='
...
administrators = [1167230855928889354] 
chat_channel = 981320242405982229
bots_channel = 981320242405982229
queue = []
...
async def on_member_join(member):
    ...
    await channel.send(f'Welcome to **Acode**, {member.mention}.\nType `=help` to get started! Yey!')
...
async def help(ctx):
    ...
    if ctx.channel.type != discord.ChannelType.private:
        ...
        embed.add_field(name='⚪️ Roblox Followers', value='`=rfollow (user id)`', inline=True)
        await ctx.send(embed=embed)
